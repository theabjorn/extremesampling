...
epsAC.loglikmaxcond = function(data, ng, cind, ll = FALSE, hessian = FALSE,snpnames){
...
epsAC.loglikmaxint = function(data,ng,interactind,hwe = FALSE,
...
epsAC.loglikmaxcondint = function(data, ng, cind,interactind,
